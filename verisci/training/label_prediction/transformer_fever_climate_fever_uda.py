...
# parser.add_argument('--data-unsup', type=str, required=True, help='raw unlabeled data for UDA')
# parser.add_argument('--data-aug', type=str, required=True, help='augmented unlabeled data for UDA')
parser.add_argument('--data-uda', type=str, required=True, help='raw and augmented unlabeled data for UDA')
